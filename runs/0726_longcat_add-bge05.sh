...
DATADIR=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/zhangrunlai/data/rider_v4/train_fix_liqing.parquet
...
WARM=no
experiment_name=0726_longcat_add-bge05
...
REWARD_MODEL_PATH1=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/ruanjingqing/program/llm/reward/verl_v1_new_grm_newRM/results/checkpoint/rl/rpp_longcat18b_data_9.6k_gapIncrease_R_00_1.15_r_11_0.9_episodes_30_actor_lr_5e-7_nsamples_16_warm_no_ray/global_step_400/actor/huggingface
