...
DATADIR=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/zhangrunlai/data/rider_feiyundan/train_feiyundan.parquet
MODELDIR=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/ruanjingqing/program/llm/reward/sft_warmup/ckpt/cot_sft_warmup_0726/zhangrunlai_kefu_agent_sft_feiyundan_v6_1_4_32gcores80g-20250726-213737/iter_0000660/huggingface_format
# REWARD_MODEL_PATH=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/caozhiquan/models/longcat_18b_V1_10_sanqing
WARM=no
experiment_name=0730_longcat_add-trained-grm03_add-bge05
is_custome_model=True
VAL_DATADIR=""
...
if [ "$NODE_RANK" -eq 0 ]; then
   ...
   ray job submit --runtime-env-json="{\"working_dir\": \"$CUR_DIR\",
    ...
    reward_model.reward_vllm_rollout.temperature=[0.7] \
    ...
    actor_rollout_ref.model.is_custome_model=$is_custome_model \
