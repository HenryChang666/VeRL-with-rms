...
WARM=no
experiment_name=0715_longcat_add-trained-grm03
...
REWARD_MODEL_PATH1=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/ruanjingqing/program/llm/reward/verl_v1_new_grm/results/checkpoint/rl/rpp_longcat18b_data__1k_episodes_30_actor_lr_5e-7_nsamples_16_warm_no_ray/global_step_240/actor/huggingface
