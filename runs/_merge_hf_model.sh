...
# 设置一些默认路径（可根据需要调整）
DEFAULT_LOCAL_DIR="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/zhangrunlai/verl/results/checkpoint/rl/longcat_18b_V1_10_sanqing/zrl_grm_longcat_w03_add-mul_nobge-sanqingrm_episodes_20_actor_lr_1e-6_nsamples_4"
...
DEFAULT_TARGET_DIR="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/zhangrunlai/verl/results/checkpoint/rl/longcat_18b_V1_10_sanqing/zrl_grm_longcat_w03_add-mul_nobge-sanqingrm_episodes_20_actor_lr_1e-6_nsamples_4"
