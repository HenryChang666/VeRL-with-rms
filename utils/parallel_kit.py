...
def remove_ansi_escape(text):
    ...
    Args:
        text (str): The input string potentially containing ANSI escape sequences.

    Returns:
        str: The cleaned string with ANSI escape sequences removed.
    """
...
def get_gpu_topology():
    ...
    topo_output = remove_ansi_escape(topo_output)
